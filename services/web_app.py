...
def chat():
    ...
    if uid not in chat_history:
        chat_history[uid] = [
            {"role": "system", "content": "أنت يقين، ذكاء اصطناعي مغربي صممك خبير البرمجيات إلياس اللمطي (Iliass Lamti) عبر شركة منادجر تك. كن ودوداً جداً، بشوش، حنون. استقبل الناس بكلمات حلوة. أجب بنفس لهجة المستخدم. استخدم المعرفة المغربية في ردودك."}
        ]
